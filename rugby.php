...
<body>
	...
	<section id="actup">
		<div class="first">
			<a href="#"><img src="images/rugby.jpeg"  alt="All Black" height="650px" width="1000px;"></a>
		</div>
		<div class="titre">
			<h1>ALL BLACK</h1>
		...
		<?php 
			...
			require 'admin/database.php';
					$db = $connexion->query('SELECT articles.id, articles.titre, articles.description, articles.fic, categorie.nom AS categorie
											FROM articles LEFT JOIN categorie ON articles.categorie = categorie.id WHERE categorie.id = 2
